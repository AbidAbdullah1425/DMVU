...
async def url_handler(client, message: Message):
    ...
    post_text = (
        ...
        f"**◆   Synopsis: In a land where no magic is present. A land where the strong make the rules and weak have to obey...**[𝗥𝗲𝗮𝗱 𝗠𝗼𝗿𝗲](https://myanimelist.net/anime/36491/Doupo_Cangqiong)\n"
    )
